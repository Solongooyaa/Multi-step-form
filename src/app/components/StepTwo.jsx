export const StepTwo = ({setCurrentStep}) => {
    return (
           ...
           <input className="w-[416px] h-[44px] mt-[8px] rounded border-solid-[1px] "
            ...
            <button className="w-[128px] h-[44px]  mt-[100px]  bg-[#D6D8DB] rounded" onClick={()=> setCurrentStep(1)}>Back</button>
            <button className="w-[280px] h-[44px] ml-[10px] mt-[100px]  bg-[#D6D8DB] rounded" onClick={()=> setCurrentStep(3)}>Continue 2/3 </button>
